insert into posts (id,is_active,moderation_status,moderation_id,user_id,time,title,text,view_count) VALUES (1,1,1,null,1,CURRENT_DATE,'Как создать проект','Смотрите во второй части ->',0);
